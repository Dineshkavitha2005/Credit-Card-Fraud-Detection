...
from app.models import (
    db, User, UserIdentity, UserCard, Transaction, Alert, FraudRule, BlockedCard, AuditLog, UserSession,
...
__all__ = [
    'db', 'User', 'UserIdentity', 'UserCard', 'Transaction', 'Alert', 'FraudRule', 'BlockedCard', 'AuditLog',
