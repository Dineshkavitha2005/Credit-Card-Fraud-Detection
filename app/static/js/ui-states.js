/**
 * Sentinel Security UI States Engine
...
(function (window, document) {
    ...
    const UIState = {
                ...
                modal.innerHTML = `
                    <div class="ui-state-modal-card">
                        <div class="ui-state-modal-icon forbidden">
                            <i class="fas fa-shield-halved" data-lucide="shield-alert"></i>
                        </div>
                        ...
                        <div style="display:flex;gap:12px;justify-content:center;">
                            <button class="btn btn-primary" onclick="UIState.closeForbiddenModal()">
                                <i class="fas fa-home" data-lucide="home" style="margin-right:6px;"></i> Return to Dashboard
                            </button>
                        </div>
                    </div>
                `;
                ...
                modal.innerHTML = `
                    <div class="ui-state-modal-card">
                        <div class="ui-state-modal-icon expired">
                            <i class="fas fa-lock" data-lucide="lock"></i>
                        </div>
                        ...
                        <div style="display:flex;gap:12px;justify-content:center;">
                            <button class="btn btn-primary" id="ui-modal-expired-btn">
                                <i class="fas fa-sign-in-alt" data-lucide="log-in" style="margin-right:6px;"></i> Sign In Again
                            </button>
                        </div>
                    </div>
                `;
        ...
        setupOfflineHandling() {
            let offlineBanner = document.getElementById('sentinel-offline-banner') || document.getElementById('offline-banner');
            ...
            if (!offlineBanner) {
                ...
                offlineBanner.innerHTML = `
                    <i class="fas fa-wifi-slash" data-lucide="wifi-off"></i>
            ...
            const updateOnlineStatus = () => {
                ...
                if (!isOnline) {
                    ...
                    if (statusDot) {
                        ...
                        statusDot.style.color = 'var(--danger, #C63D45)';
                    }
                    ...
                    if (offlineBanner.classList.contains('active')) {
                        ...
                        if (statusDot) {
                            ...
                            statusDot.style.color = 'var(--success, #16845B)';
                        }
            ...
            // Initial check: Only activate banner if client is currently offline
            if (!navigator.onLine) {
                updateOnlineStatus();
            } else {
                offlineBanner.classList.remove('active', 'restored');
        ...
        showToast(message, type = 'info', duration = 4000) {
            if (window.Sentinel && typeof window.Sentinel.showToast === 'function') {
                window.Sentinel.showToast(message, type, duration);
                return;
            }
